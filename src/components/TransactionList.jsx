    ...
    return ( 
            <div className="bg-gray-200 rounded-lg shadow-lg lg:w-[60%] sm:w-full">
                <div className="flex justify-around items-center w-full py-2">
                    ...
                    <span className="text-gray-600 text-sm sm:text-sm hidden sm:block font-bold flex-1 text-center">Category</span>
                ...
                (<div key={i} className="flex justify-around items-center  w-full bg-white py-3 border-b-2 border-b-gray-200">
                    ...
                    <span className={`text-gray-600 text-sm sm:text-sm hidden sm:block font-semibold  flex-1 text-center p-1 rounded-md bg`}>{item['category']}</span>
