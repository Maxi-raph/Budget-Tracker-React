    ...
    return ( 
            ...
            <div className="bg-gray-200 rounded-lg shadow-lg lg:w-[60%] sm:w-full">
                <div className="flex justify-around items-center w-full py-2">
                    <span className="text-gray-600 text-sm sm:text-sm font-bold flex-2 text-center">Date</span>
                    <span className="text-gray-600 text-sm sm:text-sm hidden sm:block font-bold flex-4 text-center">Description</span>
                    <span className="text-gray-600 text-sm sm:text-sm block font-bold flex-2 text-center">Category</span>
                ...
                (<div key={i} className="flex justify-around items-center  w-full bg-white py-3 border-b-2 border-b-gray-200">
                    ...
                    <span className="flex items-center justify-center px-1 text-xs rounded-lg border-2 cursor-pointer mr-1 border-gray-400 text-gray-500" onClick={()=>openModal(i,item['type'] )}><FaEdit className=" inline-block"/>Edit</span>
                    </div>
                </div>)
                )}
            </div>
