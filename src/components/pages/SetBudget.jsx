...
const SetBudget = () => {
    ...
    <div className="max-w-5xl mx-auto p-5 rounded-lg bg-white shadow-lg scroll-mt-22" id="overview">
        ...
        <div className=" gap-6 grid grid-cols-1 mb-3  lg:flex lg:w-full">
            <div className="lg:w-[40%]">
                <span className="text-gray-400 mb-1 block md:font-semibold">Budget Category <span className="inline-block text-red-400 font-semibold">*</span></span>
                <select ref={categorySelectRef} name='category' className="block p-2 font-bold border border-gray-400 cursor-pointer rounded-lg w-full" value={budgetDetails['category']} onChange={(e)=>handleCategoryChange(e)}>
                            <optgroup>
            ...
            <div className="lg:w-[40%]">
                <span className="text-gray-400 mb-1 block md:font-semibold">Amount <span className="inline-block text-red-400 font-semibold">*</span></span>
                <input name='amount' type="number" className="block p-2 font-bold border border-gray-400 cursor-pointer rounded-lg w-full" value={budgetDetails['amount']} onChange={(e)=>handleAmountChange(e)}/>
            </div>
            <button className=" bg-gray-300 cursor-pointer p-2 font-semibold rounded-lg" onClick={()=>addCategory()}><FaPlus className='mr-2 inline-block'/>Add Category</button>
        </div>
